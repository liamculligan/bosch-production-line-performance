...
#Create further features from test_numeric and test_categorical

#Load feature names of train_numeric and train_categorical
load("XGB1 Train features_numeric.rda")
features_numeric = head(features_numeric, -1)
load("XGB1 Train features_categorical.rda")
...
load("XGB1 Train unique_lines.rda")
...
load("XGB1 Train unique_stations.rda")
...
load("XGB1 Train character_names.rda")
...
write.csv(Submission, "XGB1_test.csv", row.names = F)
