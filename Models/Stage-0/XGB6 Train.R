...
save(features_numeric, file = "XGB6 Train features_numeric.rda")
...
save(unique_lines, file = "XGB6 Train unique_lines.rda")
...
save(unique_stations, file = "XGB6 Train unique_stations.rda")
...
rm(sort_features_2)
gc()
train = sort_features_3[train]
rm(sort_features_3)
gc()
train = sort_features_4[train]
rm(sort_features_4)
gc()
...
save(character_names, file = "XGB6 Train character_names.rda")
...
save(train_names, file = "XGB6 Train train_names.rda")
...
eta_values = c(0.1)
max_depth_values = c(5)
subsample_values = c(0.95)
colsample_bytree_values = c(0.7)
...
save(best_thresh, file = "XGB6_best_thresh.rda")
