...
#From DT, obtain the last line-station-feature that each part went to, that is the station with the greatest timestamp.
#Using the last column found as a tiebreaker
...
save(features_numeric, file = "XGB1 Train features_numeric.rda")
save(features_categorical, file = "XGB1 Train features_categorical.rda")
...
save(unique_lines, file = "XGB1 Train unique_lines.rda")
...
save(unique_stations, file = "XGB1 Train unique_stations.rda")
...
save(levels, file = "XGB1 Train levels.rda")
...
save(character_names, file = "XGB1 Train character_names.rda")
...
save(train_names, file = "XGB1 Train train_names.rda")
...
save(best_thresh, file = "XGB1_best_thresh.rda")
