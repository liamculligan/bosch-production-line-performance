...
save(features_numeric, file = "XGB5 Train features_numeric.rda")
...
save(unique_lines, file = "XGB5 Train unique_lines.rda")
...
save(unique_stations, file = "XGB5 Train unique_stations.rda")
...
save(character_names, file = "XGB5 Train character_names.rda")
...
save(train_names, file = "XGB5 Train train_names.rda")
...
save(best_thresh, file = "XGB5_best_thresh.rda")
