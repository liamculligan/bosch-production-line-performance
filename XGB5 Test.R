...
load("XGB5 Train features_numeric.rda")
...
load("XGB5 Train unique_lines.rda")
...
load("XGB5 Train unique_stations.rda")
...
load("XGB5 Train character_names.rda")
...
write.csv(Submission, "XGB5_test.csv", row.names = F)
